...
public abstract class BaseWireFeedGenerator implements WireFeedGenerator {
    ...
    /**
     * <p>Purging unused declarations is less optimal, performance-wise, than never adding them in the
     ...
     * is more efficient than parsing and re-molding the XML after ROME generates it.</p>
     * 
     ...
     * at generate() time, to make sure their namespace declarations are present.</p>
     */
